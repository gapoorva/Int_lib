...
function performanceTest(iterations) {
	var sums = {};
	var names = "add10 add50 add100 add1000 add10000 sub10 sub50 sub100 sub1000 sub10000 mul10 mul50 mul100 mul1000 div10 div50 div100 div1000 eq10 eq50 eq100 eq1000 eq10000 lt10 lt50 lt100 lt1000 lt10000";
	var n = iterations || 20;
	var m = 0;
	names = names.split(" ");
	...
	while (n--) {
		...
		for (var x=0; x < names.length; ++x) {
			if(!sums[names[x]]) sums[names[x]] = 0;
			sums[names[x]] += unit[names[x]];
		}
		m++;
		console.log(n,"tests left");
	}
	...
	for (var y = 0; y < names.length; ++y) {
		console.log(names[y], Math.round(sums[names[y]]/m));
	}
}
