...
0;15>h;++h)g=new Date,Int_div_fast(a[f][h],b[d][h]),e[f-d].sum+=new Date-g,e[f-d].cnt+=1;for(g=0;40>g;++g)c[g].avg=c[g].sum/c[g].cnt,e[g].avg=e[g].sum/e[g].cnt;console.log("DIG-DIFF | LONG | FAST");for(a=0;40>a;++a)console.log(a,"|",c[a].avg,"|",e[a].avg)};function performanceTest(){console.log("initializing performanceTest...");for(var a=[],b=[],c=[],e=[],d=[],f=[],h=[],g=[],k=[],m=[],l=0;10>l;++l)a.push(Math.floor(10*Math.random())),b.push(Math.floor(10*Math.random())),c.push(Math.floor(10*Math.random())),e.push(Math.floor(10*Math.random())),d.push(Math.floor(10*Math.random())),f.push(Math.floor(10*Math.random())),h.push(Math.floor(10*Math.random())),g.push(Math.floor(10*Math.random())),k.push(Math.floor(10*Math.random())),m.push(Math.floor(10*Math.random()));
for(l=0;40>l;++l)c.push(Math.floor(10*Math.random())),e.push(Math.floor(10*Math.random())),d.push(Math.floor(10*Math.random())),f.push(Math.floor(10*Math.random())),h.push(Math.floor(10*Math.random())),g.push(Math.floor(10*Math.random())),k.push(Math.floor(10*Math.random())),m.push(Math.floor(10*Math.random()));for(l=0;50>l;++l)d.push(Math.floor(10*Math.random())),f.push(Math.floor(10*Math.random())),h.push(Math.floor(10*Math.random())),g.push(Math.floor(10*Math.random())),k.push(Math.floor(10*Math.random())),
m.push(Math.floor(10*Math.random()));for(l=0;900>l;++l)h.push(Math.floor(10*Math.random())),g.push(Math.floor(10*Math.random())),k.push(Math.floor(10*Math.random())),m.push(Math.floor(10*Math.random()));for(l=0;9E3>l;++l)k.push(Math.floor(10*Math.random())),m.push(Math.floor(10*Math.random()));a=a.join("");b=b.join("");c=c.join("");e=e.join("");d=d.join("");f=f.join("");h=h.join("");g=g.join("");k=k.join("");l=m.join("");console.log("completed init");console.log("using following inputs:");console.log(a,
b,c,e,d,f,h,g,k,l);console.log("starting performance tests...");m=new Date;console.log("running add tests...");var n=new Date;Int_add(a,b);console.log("\t10 digit add:\t\t\t",new Date-n);n=new Date;Int_add(c,e);console.log("\t50 digit add:\t\t\t",new Date-n);n=new Date;Int_add(d,f);console.log("\t100 digit add:\t\t\t",new Date-n);n=new Date;Int_add(h,g);console.log("\t1000 digit add:\t\t\t",new Date-n);n=new Date;Int_add(k,l);console.log("\t10000 digit add:\t\t",new Date-n);n=new Date;Int_add(k,b);
console.log("\t10000 digit add:\t\t",new Date-n);console.log("running sub tests...");n=new Date;Int_sub(a,b);console.log("\t10 digit sub:\t\t\t",new Date-n);n=new Date;Int_sub(c,e);console.log("\t50 digit sub:\t\t\t",new Date-n);n=new Date;Int_sub(d,f);console.log("\t100 digit sub:\t\t\t",new Date-n);n=new Date;Int_sub(h,g);console.log("\t1000 digit sub:\t\t\t",new Date-n);g=new Date;Int_sub(k,l);console.log("\t10000 digit sub:\t\t",new Date-g);console.log("running mul tests...");g=new Date;Int_mul(a,
b);console.log("\t10 digit mul:\t\t\t",new Date-g);g=new Date;Int_mul(c,e);console.log("\t50 digit mul:\t\t\t",new Date-g);e=new Date;Int_mul(d,f);console.log("\t100 digit mul:\t\t\t",new Date-e);e=new Date;Int_mul(h,f);console.log("\t1000 digit mul:\t\t\t",new Date-e);console.log("running div tests...");e=new Date;Int_div(a,b);console.log("\t10 digit div:\t\t\t",new Date-e);e=new Date;Int_div(c,b);console.log("\t50 digit div:\t\t\t",new Date-e);e=new Date;Int_div(d,b);console.log("\t100 digit div:\t\t\t",
new Date-e);e=new Date;Int_div(h,b);console.log("\t1000 digit div:\t\t\t",new Date-e);console.log("running eq tests...");b=new Date;Int_eq(a,a);console.log("\t10 digit eq:\t\t\t",new Date-b);b=new Date;Int_eq(c,c);console.log("\t50 digit eq:\t\t\t",new Date-b);b=new Date;Int_eq(d,d);console.log("\t100 digit eq:\t\t\t",new Date-b);b=new Date;Int_eq(h,h);console.log("\t1000 digit eq:\t\t\t",new Date-b);b=new Date;Int_eq(k,k);console.log("\t10000 digit eq:\t\t\t",new Date-b);console.log("running lt tests...");
b=new Date;Int_lt(a,a);console.log("\t10 digit lt:\t\t\t",new Date-b);a=new Date;Int_lt(c,c);console.log("\t50 digit lt:\t\t\t",new Date-a);a=new Date;Int_lt(d,d);console.log("\t100 digit lt:\t\t\t",new Date-a);a=new Date;Int_lt(h,h);console.log("\t1000 digit lt:\t\t\t",new Date-a);a=new Date;Int_lt(k,k);console.log("\t10000 digit lt:\t\t\t",new Date-a);console.log("overall performance:",new Date-m);console.log("finished")};function Int_add(a,b){a=Int_convertToInt(a);b=Int_convertToInt(b);if(a.is0())return b;if(b.is0())return a;if(a.is_negative&&!b.is_negative)return Int_sub(b,a);if(!a.is_negative&&b.is_negative)return Int_sub(a,b);var c=a.is_negative,e=new Int("z");e.data=[];for(var d=0,f=a.data.length>b.data.length?b.data.length:a.data.length,h=0;h<f;++h)d=a.data[h]+b.data[h]+d,e.data.push(d%Int.MAX_UNIT),d=Math.floor(d/Int.MAX_UNIT);for(;f<a.data.length;)for(d=a.data[f++]+d,e.data.push(d%Int.MAX_UNIT),d=Math.floor(d/
Int.MAX_UNIT);0==d&&f<a.data.length;)e.data.push(a.data[f++]);for(;f<b.data.length;)for(d=b.data[f++]+d,e.data.push(d%Int.MAX_UNIT),d=Math.floor(d/Int.MAX_UNIT);0==d&&f<a.data.length;)e.data.push(a.data[f++]);0<d&&e.data.push(d);e.is_negative=c;return e}function Int_sum(a){for(var b=new Int("z"),c=0;c<a.length;++c)b=Int_add(b,a[c]);return b};function Int_mod(a,b){a=Int_convertToInt(a);b=Int_convertToInt(b);var c=Int_div(a,b,!0);console.log(a.is_negative);a.is_negative&&(c=Int_sub(b,c));return c}function Int_pow(a,b){Int_convertToInt(a);Int_convertToInt(b)};function Int_eq(a,b){a=Int_convertToInt(a);b=Int_convertToInt(b);if(a.is0()&&b.is0())return!0;if(a.data.length!=b.data.length||a.is_negative!=b.is_negative)return!1;for(var c=0;c<a.data.length;++c)if(a.data[c]!=b.data[c])return!1;return!0}function Int_neq(a,b){return!Int_eq(a,b)}
