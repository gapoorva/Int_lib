...
e;e=new Date;Int_div(a,b);l.div10=new Date-e;e=new Date;Int_div(c,b);l.div50=new Date-e;e=new Date;Int_div(d,b);l.div100=new Date-e;b=new Date;Int_div(h,16);l.div1000=new Date-b;b=new Date;Int_eq(a,a);l.eq10=new Date-b;b=new Date;Int_eq(c,c);l.eq50=new Date-b;b=new Date;Int_eq(d,d);l.eq100=new Date-b;b=new Date;Int_eq(h,h);l.eq1000=new Date-b;b=new Date;Int_eq(k,k);l.eq10000=new Date-b;b=new Date;Int_lt(a,a);l.lt10=new Date-b;a=new Date;Int_lt(c,c);l.lt50=new Date-a;a=new Date;Int_lt(d,d);l.lt100=
...
function Int_div_long(a,b,c,e){for(var d=a.repLength()-b.repLength(),f=new Int("z"),h=0;h<d+1;++h){for(var g=Int_ls(b,d-h),k=0;Int_gteq(a,g);)a=Int_sub(a,g),k++;f=Int_add(f,Int_ls(k,d-h))}return c?a:e?{q:f,r:a}:f}
function Int_div(a,b,c,e){a=Int_convertToInt(a);b=Int_convertToInt(b);var d=a.is_negative==b.is_negative?!1:!0;a.is_negative=!1;b.is_negative=!1;if(Int_lt(a,b))return c?new Int(a):e?{q:new Int("z"),r:new Int(a)}:new Int("z");if(Int_eq(a,b)){if(c)return new Int("z");a=new Int(1);a.is_negative=d;return e?{q:a,r:new Int("z")}:a}if(1==b.data[0])return c?new Int("z"):e?{q:new Int(a),r:new Int("z")}:new Int(a);if(0==b.data[0])return e?{q:new Int("z"),r:new Int("z")}:new Int("z");a=Int_div_long(a,b,c,e);
e?a.q.is_negative=a.r.is_negative=d:a.is_negative=d;return a};function Int_mul(a,b){a=Int_convertToInt(a);b=Int_convertToInt(b);var c=a.is_negative==b.is_negative?!1:!0;a.is_negative=!1;b.is_negative=!1;if(1==a.data.length&&1==b.data.length){var e=Math.floor(a.data[0]/1E7),d=Math.floor(b.data[0]/1E7),f=a.data[0]%1E7,h=b.data[0]%1E7,g=f*h,k=e*d,m=(e+f)*(d+h)-k-g;return c?Int_add(k.toString()+"00000000000000",Int_add(Int_ls(m,7),g)).negate():Int_add(k.toString()+"00000000000000",Int_add(Int_ls(m,7),g))}if(1==a.data.length){k=Math.floor(b.data.length/2);e=new Int("z");
